...
class MzActor:
    ...
    def __init__(
        ...
        inference_dyna_actor: Optional[RayInferenceActor] = None,
        inference_repr_actor: Optional[RayInferenceActor] = None,
        ...
        self._inference_dyna_actor = inference_dyna_actor
        self._inference_repr_actor = inference_repr_actor
            ...
            try:
                ...
                for k in repr_net_out:
                    if k == "embedding":
                        ...
                        self._latest_step = repr_net_out[k]
                    else:
    ...
    def _dyna_and_pred(
        ...
        if self._inference_dyna_actor is not None:
            ...
            dp_net_out = ray.get(self._inference_dyna_actor.get.remote(handle))
