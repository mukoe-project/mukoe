...
def select_child(
    ...
    # TODO(miaosen): Make the parent node's visit count includes the sum of
    # virtual losses of its expanded children.
    pb_c = (
        np.log(
...
def expand_node(
    ...
    if min_max_stats is not None:
        # TODO(wendyshang):
        # make the code cleaner by moving the condition to prepare_root_node
